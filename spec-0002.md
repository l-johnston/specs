---
title: "SPEC 2 — Unit Systems Support"
date: 2021-03-20
draft: true
author:
...
Numpy is currently developing extensible DTypes to replace the existing `dtype` to expand the behavior of the native `ndarray` to include unit systems among other use cases. Since the `ndarray` lies at the foundation of most, if not all, technical computing libraries, a unit system implemented with this new DType may solve the compatibility problem.
