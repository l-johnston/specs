...
# Requirements
1. Unit system libraries will implement the quantity object as an `ndarray` using the new DType.
2. Unit system libraries will provide a set of standard methods such as to perform unit conversions, get numerical values and units, and get string representations of the quantity.
3. External libraries will use the standard methods.
4. External libraries will delegate to the unit system library mathematical operations involving multiple quantities in an expression.
